...
func getItemHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	success, err := handler.(item.ItemService).GetItem(ctx, realArg.Request)
	if err != nil {
		return err
	}
...
func (p *kClient) GetItem(ctx context.Context, request *item.GetItemRequest) (r *item.GetItemResponse, err error) {
